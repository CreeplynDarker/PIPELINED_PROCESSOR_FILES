module aludec(input  opb5,
              ...
              input  funct7b5, 
              input  [1:0] ALUOp,
              output [3:0] ALUControl);          // CHANGE A2: 3:0 (antes 2:0)
  
  wire  RtypeSub; 
  reg [3:0] ALUControl_reg;                       // CHANGE A2: 3:0
  ...
  always @* case(ALUOp)
      ...
      default: case(funct3)
                 ...
                 3'b101:  if (funct7b5)                // CHANGE A2:
                            ALUControl_reg = 4'b1000; // sra, srai (aritmetico)
                          else
                            ALUControl_reg = 4'b0111; // srl, srli (logico)
